...
# This script should be run from the production-ready-observability folder
# Usage: ./data/seed_data.sh
...
if [ -f .env ]; then
    ...
    echo "❌ .env file not found. Please run infra/setup-env.sh first."
    exit 1
fi
